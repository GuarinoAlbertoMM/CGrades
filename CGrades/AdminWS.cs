    ...
    public partial class AdminWS : Form
    {
        ...
        public void DisplayTableData()
        {
            try
            {
                ...
                string query = "SELECT users.id, users.username, users.password, students.user_id, students.fullname " +
                               "FROM users " +
                    ...
                    try
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(connectionString))
                        {
                            ...
                            using (SqlCommand command = new SqlCommand(insertUserQuery, connection))
                            {
                                ...
                                string insertTeacherQuery = "INSERT INTO students (user_id, fullname) VALUES (@UserId, @Fullname);";
                ...
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(connectionString))
                        {
                            ...
                            string deleteTeacherQuery = "DELETE FROM students WHERE user_id = @UserID";
